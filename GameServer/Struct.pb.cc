...
PROTOBUF_CONSTEXPR PartyPlayer::PartyPlayer(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.playerid_)*/uint64_t{0u}
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct PartyPlayerDefaultTypeInternal {
  PROTOBUF_CONSTEXPR PartyPlayerDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~PartyPlayerDefaultTypeInternal() {}
  union {
    PartyPlayer _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PartyPlayerDefaultTypeInternal _PartyPlayer_default_instance_;
PROTOBUF_CONSTEXPR Party::Party(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.partyplayers_)*/{}
  , /*decltype(_impl_.partyid_)*/uint64_t{0u}
  , /*decltype(_impl_.partystatus_)*/0
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_Struct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::RoomItem, _impl_.state_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::PartyPlayer, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::PartyPlayer, _impl_.playerid_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::Party, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::Party, _impl_.partyid_),
  PROTOBUF_FIELD_OFFSET(::Protocol::Party, _impl_.partystatus_),
  PROTOBUF_FIELD_OFFSET(::Protocol::Party, _impl_.partyplayers_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 53, -1, -1, sizeof(::Protocol::PartyPlayer)},
  { 60, -1, -1, sizeof(::Protocol::Party)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::Protocol::_PartyPlayer_default_instance_._instance,
  &::Protocol::_Party_default_instance_._instance,
};
...
const char descriptor_table_protodef_Struct_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ue\030\004 \001(\004\022\016\n\006amount\030\005 \001(\004\"\220\001\n\010RoomItem\022\016\n"
  "\006roomId\030\001 \001(\004\022\022\n\nroomItemId\030\002 \001(\004\022\034\n\004ite"
  "m\030\003 \001(\0132\016.Protocol.Item\022\014\n\004posX\030\004 \001(\002\022\014\n"
  "\004posY\030\005 \001(\002\022&\n\005state\030\006 \001(\0162\027.Protocol.Ro"
  "omItemState\"\037\n\013PartyPlayer\022\020\n\010playerId\030\001"
  " \001(\004\"q\n\005Party\022\017\n\007partyId\030\001 \001(\004\022*\n\013partyS"
  "tatus\030\002 \001(\0162\025.Protocol.PartyStatus\022+\n\014pa"
  "rtyPlayers\030\003 \003(\0132\025.Protocol.PartyPlayerb"
  "\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_Struct_2eproto = {
    false, false, 687, descriptor_table_protodef_Struct_2eproto,
    "Struct.proto",
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          uint64_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_state(static_cast<::Protocol::RoomItemState>(val));
        } else
          goto handle_unusual;
        continue;
      default:
...
void RoomItem::InternalSwap(RoomItem* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RoomItem, _impl_.state_)
      + sizeof(RoomItem::_impl_.state_)
...
class PartyPlayer::_Internal {
 public:
};

PartyPlayer::PartyPlayer(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.PartyPlayer)
}
PartyPlayer::PartyPlayer(const PartyPlayer& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  PartyPlayer* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:Protocol.PartyPlayer)
}

inline void PartyPlayer::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
PartyPlayer::~PartyPlayer() {
  // @@protoc_insertion_point(destructor:Protocol.PartyPlayer)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void PartyPlayer::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void PartyPlayer::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void PartyPlayer::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.PartyPlayer)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* PartyPlayer::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* PartyPlayer::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.PartyPlayer)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.PartyPlayer)
  return target;
}

size_t PartyPlayer::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.PartyPlayer)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData PartyPlayer::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    PartyPlayer::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*PartyPlayer::GetClassData() const { return &_class_data_; }


void PartyPlayer::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<PartyPlayer*>(&to_msg);
  auto& from = static_cast<const PartyPlayer&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.PartyPlayer)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void PartyPlayer::CopyFrom(const PartyPlayer& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.PartyPlayer)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool PartyPlayer::IsInitialized() const {
  return true;
}

void PartyPlayer::InternalSwap(PartyPlayer* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_.playerid_, other->_impl_.playerid_);
}

::PROTOBUF_NAMESPACE_ID::Metadata PartyPlayer::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Struct_2eproto_getter, &descriptor_table_Struct_2eproto_once,
...
Party::Party(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.Party)
}
Party::Party(const Party& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  Party* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.partyplayers_){from._impl_.partyplayers_}
    , decltype(_impl_.partyid_){}
    , decltype(_impl_.partystatus_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.partyid_, &from._impl_.partyid_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.partystatus_) -
    reinterpret_cast<char*>(&_impl_.partyid_)) + sizeof(_impl_.partystatus_));
  // @@protoc_insertion_point(copy_constructor:Protocol.Party)
}
...
inline void Party::SharedCtor(
  ...
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.partyplayers_){arena}
    , decltype(_impl_.partyid_){uint64_t{0u}}
    , decltype(_impl_.partystatus_){0}
    , /*decltype(_impl_._cached_size_)*/{}
  };
...
Party::~Party() {
  // @@protoc_insertion_point(destructor:Protocol.Party)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void Party::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.partyplayers_.~RepeatedPtrField();
}
...
void Party::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.Party)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  ::memset(&_impl_.partyid_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.partystatus_) -
      reinterpret_cast<char*>(&_impl_.partyid_)) + sizeof(_impl_.partystatus_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          uint64_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_partystatus(static_cast<::Protocol::PartyStatus>(val));
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_partyplayers(), ptr);
            CHK_(ptr);
...
uint8_t* Party::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.Party)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // .Protocol.PartyStatus partyStatus = 2;
  if (this->_internal_partystatus() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      2, this->_internal_partystatus(), target);
  }

  // repeated .Protocol.PartyPlayer partyPlayers = 3;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_partyplayers_size()); i < n; i++) {
    const auto& repfield = this->_internal_partyplayers(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.Party)
  return target;
}

size_t Party::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.Party)
  size_t total_size = 0;
  ...
  // repeated .Protocol.PartyPlayer partyPlayers = 3;
  total_size += 1UL * this->_internal_partyplayers_size();
  for (const auto& msg : this->_impl_.partyplayers_) {
    total_size +=
  ...
  if (this->_internal_partystatus() != 0) {
    total_size += 1 +
      ::_pbi::WireFormatLite::EnumSize(this->_internal_partystatus());
  }
...
void Party::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<Party*>(&to_msg);
  auto& from = static_cast<const Party&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.Party)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  _this->_impl_.partyplayers_.MergeFrom(from._impl_.partyplayers_);
  if (from._internal_partyid() != 0) {
    _this->_internal_set_partyid(from._internal_partyid());
  }
  if (from._internal_partystatus() != 0) {
    _this->_internal_set_partystatus(from._internal_partystatus());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void Party::CopyFrom(const Party& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.Party)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Party::InternalSwap(Party* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.partyplayers_.InternalSwap(&other->_impl_.partyplayers_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Party, _impl_.partystatus_)
      + sizeof(Party::_impl_.partystatus_)
      - PROTOBUF_FIELD_OFFSET(Party, _impl_.partyid_)>(
...
template<> PROTOBUF_NOINLINE ::Protocol::PartyPlayer*
Arena::CreateMaybeMessage< ::Protocol::PartyPlayer >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::PartyPlayer >(arena);
}
template<> PROTOBUF_NOINLINE ::Protocol::Party*
Arena::CreateMaybeMessage< ::Protocol::Party >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::Party >(arena);
}
